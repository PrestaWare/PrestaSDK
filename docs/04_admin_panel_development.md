...
The first step to creating a page in the admin area is to build a controller class. This class must extend PrestaSDK\V072\Controller\AdminController. This base class provides all the functionalities of PrestaShop's ModuleAdminController along with the features of PanelCore.
Steps:
...
PrestaSDK extends PrestaShop's standard HelperForm class with more utility methods. To use it, simply create an instance of `PrestaSDK\V072\Utility\HelperForm`.
