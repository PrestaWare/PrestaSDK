...
class PrestaSDKFactory
{
    ...
    {
        $fullClassName = "\\PrestaSDK\\V050\\Utility\\{$className}";
    ...
    {
        $fullClassName = "\\PrestaSDK\\V050\\Install\\{$className}";
        return self::createInstance($fullClassName, $params);
    }
    ...
    {
        $fullClassName = "\\PrestaSDK\\V050\\Model\\{$className}";
        return self::createInstance($fullClassName, $params);
    }
    ...
    {
        $fullClassName = "\\PrestaSDK\\V050\\Controller\\{$className}";
        return self::createInstance($fullClassName, $params);
    }
